...
def main():
    ...
    frontend_path = os.path.join(project_root, "mobile_app", "REPORTS", "app", "app seleium testing.xlsx")
    backend_path = os.path.join(project_root, "mobile_app", "REPORTS", "app", "app security test.xlsx")
